 ...
 * @author rock
 */
@WebServlet(name = "BuyPointServlet", urlPatterns = {"/BuyPointServlet"})
public class BuyPointServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BuyPointBean bean=(BuyPointBean)sc.getAttribute("bean");
            if (bean==null)
            {
                bean = new BuyPointBean();
            ...
            else
            {
                ...
                currentUser=AddPoint.addPoint(currentUser, bean);
