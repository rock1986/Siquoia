<%-- 
    ...
    Author     : rock
--%>
<jsp:useBean id="bean" class="BuyPointServ.BuyPointBean" scope="application" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <form action="http://localhost:8080/Siquoia/BuyPointServlet" method="post" class="pmtpg" id="form_pmtpg">
                ...
                <!-- Amount -->
                       <div class="row">
                                ...
                                <div class="cell_right right">
                                        $<input type="text" name="amount" id="amount_no_radio" value="${bean.getAmount()}" class="decimal tally right money" maxlength="12" 
                                                <% String amount=bean.getAmount();
                                                    if (!bean.isFirsttime() && !bean.hasAttribute(amount))
                                                    {
                                                        out.print("style=\"width: 70px; background-color: white; border-width:1px; border-color:red; border-style:solid;\"");
                                                    }
                                                    else
                                                    {
                                                        out.print("style=\"width: 70px; background-color: white;\"");
                                                    }
                                                %>
                                         /><br/>
                                        <% 
                        ...
                        <div class="row">
                                <div class="cell_double right" id="range_text">
                                 ($1.00 = 10 points)			</div>
                        </div>
